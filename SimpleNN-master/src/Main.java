...
public class Main {
    ...
    private static void digits() throws IOException {
        ...
        NeuralNetwork nn = new NeuralNetwork(0.001, sigmoid, dsigmoid, 784, 128, 128, 64, 32, 10);

        int samples = 60000;
        BufferedImage[] images = new BufferedImage[samples];
        int[] digits = new int[samples];
        File[] imagesFiles = new File("C:\\Users\\Дмитрий Салихов\\Desktop\\train").listFiles();
